...
const CreateService_1 = __importDefault(require("../services/BulkMessagesServices/CreateService"));
const ShowService_1 = __importDefault(require("../services/BulkMessagesServices/ShowService"));
const FindAllService_1 = __importDefault(require("../services/BulkMessagesServices/ListAllService"));
const DeleteService_1 = __importDefault(require("../services/BulkMessagesServices/RemoveService"));
